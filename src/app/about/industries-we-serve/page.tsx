  ...
  const industries = [
    {
      ...
      icon: <Sparkle size={26} color="#EC4899" />,
      color: "#EC4899",
    ...
    },
    {
      ...
      icon: <Apple size={26} color="#D97706" />,
      color: "#D97706",
    ...
    },
    {
      ...
      icon: <Flower size={26} color="#8B5CF6" />,
      color: "#8B5CF6",
            ...
            >
              <div style={{ display: "flex", justifyContent: "space-between", alignItems: "flex-start", gap: "16px", flexWrap: "wrap", marginBottom: "16px" }}>
                <div style={{ display: "flex", alignItems: "center", gap: "16px" }}>
                  ...
                  <div>
                    <h2 style={{ fontSize: "1.5rem", fontWeight: 700, color: "#180D26", margin: "0 0 4px 0" }}>
                      {ind.title}
                    </h2>
                    <span style={{ fontSize: "0.85rem", fontWeight: 700, color: ind.color }}>
                      {ind.subtitle}
                    </span>
                  </div>
                </div>
              ...
              <p style={{ fontSize: "1rem", color: "#3B284C", lineHeight: 1.75, marginBottom: "20px" }}>
                {ind.desc}
              </p>
