...
interface AboutHoverDropdownProps {
  isLightNav: boolean;
  textColor: string;
  textShadow: string;
}
...
export const ABOUT_SUBMENU = [
  {
    name: "Profile",
    href: "/about/profile",
    desc: "Division of Mother Herbs, herbal supply chain mastery & R&D",
  ...
  },
  {
    name: "Why Us",
    href: "/about/why-us",
    desc: "Dynamic R&D, terroir sourcing & dual GC-MS batch verification",
